...
activities = {
    ...
    "Basketball Team": {
        "description": "Team-based basketball practice and tournaments",
        "schedule": "Mondays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["alex@mergington.edu", "julia@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim training and recreational aquatic activities",
    ...
    "Art Club": {
        ...
        "max_participants": 15,
        "participants": ["chloe@mergington.edu", "maya@mergington.edu"]
    },
    "Drama Society": {
